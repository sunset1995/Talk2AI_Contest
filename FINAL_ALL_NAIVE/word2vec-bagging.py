...
model_names = [
    'word2vec/dual-lstm-12-best',
    'word2vec/dual-lstm-12-newest',
    'word2vec/dual-lstm-13-best',
    'word2vec/dual-lstm-13-newest',
    'word2vec/dual-lstm-14-best',
    # 'word2vec/dual-lstm-14-newest',
    'word2vec/dual-lstm-15-best',
    'word2vec/dual-lstm-15-newest',
    'word2vec/dual-lstm-16-best',
    'word2vec/dual-lstm-16-newest',
    'word2vec/dual-lstm-17-best',
    'word2vec/dual-lstm-17-newest',
    'word2vec/dual-lstm-18-best',
    'word2vec/dual-lstm-18-newest',
    'word2vec/dual-lstm-22-best',
    # 'word2vec/dual-lstm-22-newest',
    'word2vec/dual-lstm-24-best',
    'word2vec/dual-lstm-24-newest',
    'word2vec/smn-1-best',
    'word2vec/smn-1-newest',
]
...
answers = np.array(answers)
mode_ans = stats.mode(answers).mode[0]
